  ...
  return (
    <section ref={aboutRef} className="bg-white py-12 px-6 md:px-20">
      ...
      <div className="bg-blue-900 text-white text-center py-12 rounded-2xl shadow-lg mb-10">
        <h1 className="sm:text-4xl text-2xl font-bold mb-2">🚘 Ojiakaanu Auto’s</h1>
      ...
      <div className="max-w-4xl mx-auto space-y-6 text-center">
        ...
        <p className="text-gray-600 text-lg">
          At Contact Ojiakaanu Auto’s, we specialize in imported cars — both brand new and foreign used (Tokunbo) — carefully selected to meet your taste, style, and budget. Whether you're looking for durability, luxury, or everyday comfort, we’ve got the perfect ride just for you.
        </p>
        <p className="text-gray-600 text-lg">
      ...
      <div className="mt-12 text-center">
        ...
        <h2 className="text-2xl font-bold text-blue-700">Ride with Contact Ojiakaanu Auto’s.</h2>
      </div>
    </section>
  );
};
